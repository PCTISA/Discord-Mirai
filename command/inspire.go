...
func (c Inspire) Init(m *disgomux.Mux) {
	// Nothing to init
}

// Handle is called by the multiplexer whenever a user triggers the command.
func (c Inspire) Handle(ctx *disgomux.Context) {
...
// false.
func (c Inspire) HandleHelp(ctx *disgomux.Context) bool {
...
func (c Inspire) Settings() *disgomux.CommandSettings {
...
func (c Inspire) Permissions() *disgomux.CommandPermissions {
